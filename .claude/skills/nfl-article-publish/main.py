...
def main(article_name):
    ...
    # Phase 7: Archive Article Prompt (Optional)
    print("Phase 7: Archive Article")
    print("-" * 40)
    print("After publishing to Medium, you can archive the article for portfolio tracking.")
    print("\n📦 Archive this article now?")
    print("\nThis will:")
    print("  • Copy source markdown and images to medium-publishing-standards/published/")
    print("  • Generate PDF snapshot from Medium URL")
    ...
    print(f"    --geo-score=\"{geo_data['score']}\" \\")
    print(f"    --github-pages-url=\"{urls['github_pages']}\"\n")
    print("Note: Archive requires the Medium article URL (available after import/publish)\n")
